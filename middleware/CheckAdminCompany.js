...
const CheckAdminCompany = async (req, res, next) => {
  try {
    ...
    if ((!HR) && (!CEO) && (user.role != "Admin")) return res.status(403).json("UnAuthorizationff Action")
...
module.exports = CheckAdminCompany
